# AGENTS.md — Estado del Proyecto y Bitácora

## Estado Actual del Plan
| Sesión | Estado | Descripción | Entregables |
|---|---|---|---|
| **S1** | ✅ `completed` | Scaffolding + Marco normativo | Estructura de carpetas, PLAN.md, AGENTS.md, FUENTES.md, README.md, venv, PDFs |
...
| **S4** | 🔵 `in_progress` | UD00: Presentación y Entorno | Teoría y guía de herramientas |
| **S5** | ⬜ `pending` | UD01: Transformación Digital | Teoría y casos prácticos |
| **S6** | ⬜ `pending` | UD02: Ciberseguridad Básica | Contenidos teóricos y prácticos |
| **S7** | ⬜ `pending` | UD03: Automatización e IA | Talleres y notebooks |
...
- **2026-09-01**: Definición de la Programación Didáctica (Sesión 2), adaptando las 30 horas del módulo a 2º curso de ASIR en 5 unidades didácticas (UD00 a UD04), con ponderación de 40% prácticas y 60% exámenes.
...
- Idioma: Castellano (`es-ES`).
- Licencia: CC BY-NC-SA 4.0.
- Control de versiones: Git con commits descriptivos al final de cada sesión.
