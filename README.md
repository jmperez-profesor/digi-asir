...
- `docs/`: Contenido en Markdown para la web MkDocs (UD1 a UD7 y prácticas).
- `legislacion/`: Programación didáctica oficial, banco de pruebas y normativa.
- `moodle/`: Especificación y estructura de curso Moodle.
- `curriculo.yml`: Fuente única de datos curriculares.
